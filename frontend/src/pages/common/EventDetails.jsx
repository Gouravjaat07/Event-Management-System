        ...
        <div className={darkMode ? 'dark' : ''}>
            ...
            <div className="min-h-screen bg-[#F5F1DC] dark:bg-slate-900 transition-colors duration-300">
                ...
                <div className="relative container mx-auto px-3 py-4 md:px-4 md:py-6 lg:px-8 lg:py-8 max-w-7xl">
                    ...
                    {/* Hero Banner Section - Consistent Layout */}
                    <motion.div
...
//             <p><b>Event Date:</b> {new Date(event.eventDate).toDateString()}</p>
//             <p><b>Participation:</b> {event.participationType}</p>
//             <p><b>Team Size:</b> {event.teamSize}</p>
//             <p><b>Rules:</b> {event.rules.join(",")} </p>
//             <p><b>Perks:</b> {event.perks.join(",")} </p>
//             <p><b>Prizes:</b> {event.prizes}</p>
//             <p><b>Registration Deadline:</b></p>
//             <p><b>Legal:</b> {event.legalNotice} </p>
...
//             {deadlinePassed && <p>Registration closed</p>}
//         </div>
//     );
// };
...
// //         await createRegistration(event._id, data);
// //         setShowForm(false);
// //     };
...
// //             });
// //             alert("Successfully regisrtered for event");
// //         } catch {
