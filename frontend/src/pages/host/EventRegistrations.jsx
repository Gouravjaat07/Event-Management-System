                  ...
                  >
                    ...
                    <div className="p-4 md:p-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                        ...
                        {/* Roll No */}
                        {reg.rollNo && (
                          <div className="p-3 md:p-4 rounded-lg md:rounded-xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
                            <div className="flex items-center gap-2 mb-1 md:mb-2">
                              <Hash className="w-3 md:w-4 h-3 md:h-4 text-yellow-600 dark:text-yellow-400" />
                              <span className="text-[10px] md:text-xs font-semibold text-yellow-600 dark:text-yellow-400 uppercase">Roll No</span>
                            </div>
                            <p className="text-xs md:text-sm font-bold text-gray-900 dark:text-white">
                              {reg.rollNo}
                            </p>
                        ...
                        {/* Department */}
                        {reg.department && (
                          <div className="p-3 md:p-4 rounded-lg md:rounded-xl bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800">
                            <div className="flex items-center gap-2 mb-1 md:mb-2">
                              <Layers className="w-3 md:w-4 h-3 md:h-4 text-teal-600 dark:text-teal-400" />
                              <span className="text-[10px] md:text-xs font-semibold text-teal-600 dark:text-teal-400 uppercase">Department</span>
                            </div>
                            <p className="text-xs md:text-sm font-bold text-gray-900 dark:text-white">
                              {reg.department}
                            </p>
                        ...
                        {/* Project Name */}
                        {reg.projectName && (
                          <div className="p-3 md:p-4 rounded-lg md:rounded-xl bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800">
                            <div className="flex items-center gap-2 mb-1 md:mb-2">
                              <FolderOpen className="w-3 md:w-4 h-3 md:h-4 text-rose-600 dark:text-rose-400" />
                              <span className="text-[10px] md:text-xs font-semibold text-rose-600 dark:text-rose-400 uppercase">Project Name</span>
                            </div>
                            <p className="text-xs md:text-sm font-bold text-gray-900 dark:text-white truncate">
                              {reg.projectName}
                            </p>
                        ...
                        {/* Prototype Link */}
                        {reg.prototypeLink && (
                          <div className="p-3 md:p-4 rounded-lg md:rounded-xl bg-sky-50 dark:bg-sky-900/20 border border-sky-200 dark:border-sky-800">
                            <div className="flex items-center gap-2 mb-1 md:mb-2">
                              <LinkIcon className="w-3 md:w-4 h-3 md:h-4 text-sky-600 dark:text-sky-400" />
                              <span className="text-[10px] md:text-xs font-semibold text-sky-600 dark:text-sky-400 uppercase">
                                Prototype Link
                              </span>
                            </div>

                            <a
                              href={reg.prototypeLink}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-xs md:text-sm font-bold text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300 hover:underline transition-colors"
                            >
                              Open Drive
                            </a>
                          </div>
                        ...
                        {reg.projectDescription && (
                          <div className="sm:col-span-2 lg:col-span-3 p-3 md:p-4 rounded-lg md:rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                            <div className="flex items-center gap-2 mb-1 md:mb-2">
                              <AlignLeft className="w-3 md:w-4 h-3 md:h-4 text-amber-600 dark:text-amber-400" />
                              <span className="text-[10px] md:text-xs font-semibold text-amber-600 dark:text-amber-400 uppercase">Project Description</span>
                            </div>
                            <p className="text-xs md:text-sm font-bold text-gray-900 dark:text-white leading-relaxed">
                              {reg.projectDescription}
                            </p>
                          </div>
                        )}

                        {/* Team Members (if team) — updated to object structure */}
                          ...
                          <div className="sm:col-span-2 lg:col-span-3 p-3 md:p-4 rounded-lg md:rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-3">
                              {reg.teamMembers.map((member, idx) => (
                                <div
                                  key={idx}
                                  className="p-2.5 md:p-3 rounded-lg bg-white dark:bg-gray-800 border border-purple-200 dark:border-purple-700"
                                >
                                  <p className="text-xs md:text-sm font-bold text-gray-900 dark:text-white truncate">
                                    {member.name || 'N/A'}
                                  </p>
